...
const SECTIONS = [
  ...
  {
    title: '제3조 (서비스의 내용)',
    body: `서비스는 다음과 같은 기능을 제공합니다.\n① 개인 캘린더 및 일정 관리 (월·주·연도 뷰, 드래그 앤 드롭)\n② 할일(투두) 목록 관리 (우선순위, 카테고리, 반복 일정, 마감일)\n③ 마감 알림 기능 (헤더 벨 알림, 브라우저 Push 알림)\n   - 알림 유형별 on/off 설정 (마감 정시·30분 전·1시간 전·오전 9시)\n   - 알림 항목 클릭 시 해당 태스크로 직접 이동\n④ 팀 캘린더 공유 및 협업 (유료 플랜)\n⑤ AI 기반 텍스트·PDF 할일 추출, AI 어시스턴트 채팅\n⑥ Google Calendar·Notion·Slack 외부 서비스 연동\n⑦ 통계 분석 (요일별·시간대별 완료 패턴)\n⑧ ICS 파일 내보내기\n⑨ 기타 서비스가 추가·개발하는 기능`,
  },
  {
    title: '제4조 (이용자의 의무)',
