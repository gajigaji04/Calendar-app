...
const SECTIONS = [
  {
    ...
    body: `TeamCalendar는 서비스 이용을 위해 아래와 같은 개인정보를 수집합니다.\n\n[필수 항목]\n- 이메일 주소\n- 비밀번호 (암호화 저장)\n- 이름 (닉네임)\n\n[소셜 로그인 시 자동 수집]\n- 제공자(Google, GitHub, Kakao)로부터 이메일, 이름, 프로필 이미지\n\n[서비스 이용 중 생성되는 정보]\n- 일정 및 할일 데이터 (제목, 날짜, 마감일, 우선순위, 카테고리 등)\n- 접속 로그, 기기 정보\n\n[기기 내 저장 정보 (서버 미전송)]\n- 브라우저 알림 설정 (on/off, 유형별 토글) — 이용자 기기의 localStorage에만 저장되며 외부로 전송되지 않습니다.`,
  },
  {
    title: '2. 개인정보 수집 및 이용 목적',
    body: `수집한 개인정보는 다음의 목적으로만 이용됩니다.\n① 회원 식별 및 로그인 처리\n② 서비스 제공 및 운영 (캘린더, 할일, 마감 알림, 팀 협업, AI 기능 등)\n③ 외부 서비스 연동 처리 (Google Calendar, Notion, Slack)\n④ 고객 문의 및 불만 처리\n⑤ 서비스 개선을 위한 통계 분석\n⑥ 법령에 따른 의무 이행`,
  },
  {
  ...
  },
  {
    ...
    body: `TeamCalendar는 이용자의 개인정보를 보호하기 위해 다음과 같은 조치를 취하고 있습니다.\n① 비밀번호 단방향 암호화 저장 (bcrypt)\n② Row Level Security (RLS)로 데이터 접근 제어 — 본인 데이터만 조회·수정 가능\n③ HTTPS 통신 암호화\n④ Supabase 인증 토큰 기반 세션 관리\n⑤ 알림 설정 등 민감하지 않은 UI 환경설정은 서버에 저장하지 않고 이용자 기기 로컬에만 보관`,
  },
  {
      ...
      <div style={{ maxWidth:'768px', margin:'0 auto', padding:'60px 32px 96px' }}>
        <div style={{ marginBottom:'48px' }}>
          ...
          <p style={{ fontSize:'13.5px', color:DIM }}>
            시행일: 2026년 1월 1일 &nbsp;·&nbsp; 최종 수정: 2026년 6월 2일
          </p>
        </div>
